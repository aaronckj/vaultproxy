# Changelog — Pre-v1.0 History (iterations 1–103)

This file archives the full development history prior to the v1.0.0-beta.1
release milestone. For current and future changes see [`CHANGELOG.md`](CHANGELOG.md).
